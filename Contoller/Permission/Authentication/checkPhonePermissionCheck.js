    ...
    check: function (data, user) {
        ...
        if (!user) {
            ...
            if (!data.hasOwnProperty('country'))
                return new err(pv.errCode.invalid_arguments, undefined, {'param': ['country']}).jsonErr();
            else {
            ...
            if (!data.hasOwnProperty('language'))
                return new err(pv.errCode.invalid_arguments, undefined, {'param': ['language']}).jsonErr();
            else {
                if (!pv.support.language.hasOwnProperty(data.language)) {
                    ...
                    data.language = pv.defultValue.language;
                }
            }
            // db.createUser(data.phone_number);
        ...
        var result = CheckPhone.call(data, user);
